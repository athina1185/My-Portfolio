...
const Navbar = () => {
  ...
  return (
    <div style={{backgroundColor: `${navBg}`}}className={shadow ? "fixed w-full h-20 shadow-xl z-[100] " :"fixed w-full h-20 z-[100] " }>
      <div className="flex justify-between items-center w-full  px-3 2xl:px-16 pt-4">
        ...
        <div className={nav ? "fixed left-0 top-0 w-[75%] sm:w-[60%] md:[45%] h-screen bg-[#f2f2f2] p-10 ease-in duration-500" : "fixed left-[-100%] top-0 p-10 ease-in duration-500"}>
         <div>
           <div className="flex w-full items-center justify-between">
             <Link href='/'><h1 className="static text-xl text-transparent font-bold -font-burtons bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-500">&lt;ATHINA CODEs/&gt;</h1></Link>
