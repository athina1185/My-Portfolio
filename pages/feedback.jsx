  ...
  return (
    <div className="w-full">
        <div className="w-screen h-[30vh] lg:h-[40vh] relative">
            ...
            <Image className="absolute z-1" layout="fill" objectFit="cover" src={feedbackImg}/>
            <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] z-10 text-white p-2">
                <h2 className="py-2">Feedback App</h2>
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
              <h2>Overview</h2>
              <p>This is a feedback app, that allows users to write and delete reviews,with real time validations</p>
          ...
          <div className="col-span-4 md:col-span-1 shadow-lg shadow-gray-400 rounded-lg py-4">
            <div className="p-2">
              ...
              <div className="grid grid-cols-3 md:grid-cols-1">
                  ...
                  <p className="py-2 flex items-center justify-center text-gray-600"><FaCircle className="pr-1"/>React Router </p>
                  <p className="py-2 flex items-center justify-center text-gray-600"><FaCircle className="pr-1"/>CSS </p>
                  <p className="py-2 flex items-center justify-center text-gray-600"><FaCircle className="pr-1"/>Context API</p>
                  </div>
            </div>
          </div>
          <Link href="/">
